...
func TestHandleHintToolUsesClientDefaultNamespaceOverride(t *testing.T) {
	t.Parallel()
		...
		Extra: &mcpsdk.RequestExtra{
			TokenInfo: &mcpauth.TokenInfo{
				...
				Extra: map[string]any{
					mcpoauth.TokenInfoExtraDefaultNamespace: "chatgpt",
				},
			},
		},
	}
	...
	if out.DefaultNamespace != "chatgpt" {
		t.Fatalf("expected default namespace chatgpt, got %q", out.DefaultNamespace)
	}
}
