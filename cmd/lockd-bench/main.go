...
func main() {
	cfg := benchConfig{
		...
		baselineQueryFile:     defaultQueryDiskBaselinePath,
	}
	flag.StringVar(&cfg.mode, "mode", cfg.mode, "bench mode: load, update, acquire, baseline, baseline-mark-golden, baseline-report")
	...
	flag.StringVar(&cfg.baselineQueryFile, "baseline-query-file", cfg.baselineQueryFile, "query baseline JSON path for mode=baseline-report")
	flag.Parse()
