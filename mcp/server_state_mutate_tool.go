...
func (s *server) handleStateMutateTool(ctx context.Context, req *mcpsdk.CallToolRequest, input stateMutateToolInput) (*mcpsdk.CallToolResult, stateMutateToolOutput, error) {
