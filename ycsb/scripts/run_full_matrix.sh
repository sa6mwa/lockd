...
echo "  run_id       : $RUN_ID"
echo "  guard_enable : ${YCSB_GUARD_ENABLE:-1}"
echo "  guard_mem_kb : ${YCSB_GUARD_MIN_MEM_AVAILABLE_KB:-2097152}"
echo "  guard_swap_kb: ${YCSB_GUARD_MAX_SWAP_USED_KB:-1048576}"
echo "  guard_timeout: ${YCSB_GUARD_TIMEOUT_SECS:-0}"
