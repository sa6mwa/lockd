...
func (benchmarkLogger) LogLevel(level port.Level) port.ForLogging                             { return benchmarkLogger{} }
func (benchmarkLogger) LogLevelFromEnv(string) port.ForLogging                                { return benchmarkLogger{} }
func (benchmarkLogger) WithLogLevel() port.ForLogging                                         { return benchmarkLogger{} }
func (benchmarkLogger) With(keyvals ...any) port.ForLogging                                   { return benchmarkLogger{} }
func (benchmarkLogger) Log(ctx context.Context, level slog.Level, msg string, keyvals ...any) {}
func (benchmarkLogger) Logp(level port.Level, msg string, keyvals ...any)                     {}
func (benchmarkLogger) Logs(level string, msg string, keyvals ...any)                         {}
func (benchmarkLogger) Logf(level port.Level, format string, v ...any)                        {}
