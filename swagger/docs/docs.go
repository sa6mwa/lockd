...
const docTemplate = `{
        ...
        "/v1/mutate": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "LQL mutation request payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.MutateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/update": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Optional lowercase hex SHA-256 checksum for the submitted JSON bytes (pre-compaction)",
                        "name": "X-Expected-SHA256",
                        "in": "header"
                    },
                    {
                        "type": "string",
                        "description": "Optional exact byte length for the submitted JSON bytes (pre-compaction)",
                        "name": "X-Expected-Bytes",
                        "in": "header"
                    },
                    {
    ...
    "definitions": {
        ...
        "api.MutateRequest": {
            ...
            "properties": {
                "mutations": {
                    "description": "Mutations contains one or more LQL mutation expressions in execution order.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "namespace": {
                    "description": "Namespace scopes the request to a lockd namespace. Empty uses the server default.",
                    "type": "string"
                }
            }
        },
