...
// v1.67.1 declares module path gopkg.in/ini.v1 and breaks upgrades for
// dependencies importing github.com/go-ini/ini.
exclude github.com/go-ini/ini v1.67.1
...
require pkt.systems/version v0.4.0
